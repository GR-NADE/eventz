    ...
    try
    {
        const response = await axios.post(
            'https://api.brevo.com/v3/smtp/email',
            {
                sender: {
                    name: 'Eventz',
                    email: 'eventz.notifications@gmail.com'
                },
                to: [{ email: email }],
                subject: 'Verify Your Eventz Account',
                htmlContent: `
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
                        <h2 style="color: #007AFF; text-align: center;">Welcome to Eventz!</h2>
                        <p>Hi <strong>${username}</strong>,</p>
                        <p>Please verify your email address to activate your account:</p>
                        
                        <div style="text-align: center; margin: 25px 0;">
                            <a href="${verificationUrl}" 
                               style="background-color: #007AFF; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
                                ✅ Verify My Email
                            </a>
                        </div>
                        
                        <p>Or copy this link:</p>
                        <div style="background-color: #f8f9fa; padding: 12px; border-radius: 6px; border-left: 4px solid #007AFF;">
                            <code style="word-break: break-all; font-size: 13px; color: #333;">${verificationUrl}</code>
                        </div>
                        
                        <p style="margin-top: 25px; color: #666;">This link expires in 24 hours.</p>
